...
class Airports(models.Model):
    ...
    latitude_deg: str = models.CharField(verbose_name="latitude", max_length=500, null=True, blank=True)
    longitude_deg: str = models.CharField(verbose_name="longitude", max_length=500, null=True, blank=True)
